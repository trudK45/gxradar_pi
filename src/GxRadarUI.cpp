...
ControlDialogBase::ControlDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	NoXmitButton = new wxButton( this, wxID_ANY, _("No Xmit Zone"), wxDefaultPosition, wxDefaultSize, 0 );
	boxsizer->Add( NoXmitButton, 0, wxALL, 5 );
	...
	NoXmitButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ControlDialogBase::OnNoXmitDialogClick ), NULL, this );
...
ControlDialogBase::~ControlDialogBase()
{
	...
	NoXmitButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( ControlDialogBase::OnNoXmitDialogClick ), NULL, this );
...
RangeDialogBase::RangeDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString GainControlSelectChoices[] = { _("Auto High"), _("Auto Low"), _("Manual") };
	int GainControlSelectNChoices = sizeof( GainControlSelectChoices ) / sizeof( wxString );
	GainControlSelect = new wxRadioBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, GainControlSelectNChoices, GainControlSelectChoices, 1, wxRA_SPECIFY_COLS );
	GainControlSelect->SetSelection( 2 );
...
NoiseDialogBase::NoiseDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString SeaClutterOnOffChoices[] = { _("Off"), _("On") };
	int SeaClutterOnOffNChoices = sizeof( SeaClutterOnOffChoices ) / sizeof( wxString );
	SeaClutterOnOff = new wxRadioBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, SeaClutterOnOffNChoices, SeaClutterOnOffChoices, 1, wxRA_SPECIFY_ROWS );
	SeaClutterOnOff->SetSelection( 1 );
	sbSizer6->Add( SeaClutterOnOff, 0, wxALL, 5 );
	
	wxString SeaClutterModeSelectChoices[] = { _("Man"), _("Calm"), _("Med"), _("Rough") };
	...
	wxString RainClutterOnOffChoices[] = { _("Off"), _("On") };
	int RainClutterOnOffNChoices = sizeof( RainClutterOnOffChoices ) / sizeof( wxString );
	RainClutterOnOff = new wxRadioBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, RainClutterOnOffNChoices, RainClutterOnOffChoices, 1, wxRA_SPECIFY_ROWS );
	RainClutterOnOff->SetSelection( 0 );
	sbSizer8->Add( RainClutterOnOff, 0, wxALL, 5 );
	...
	SeaClutterOnOff->Connect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( NoiseDialogBase::OnSeaClutterOnOffClick ), NULL, this );
	...
	RainClutterOnOff->Connect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( NoiseDialogBase::OnRainClutterModeClick ), NULL, this );
...
NoiseDialogBase::~NoiseDialogBase()
{
	...
	SeaClutterOnOff->Disconnect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( NoiseDialogBase::OnSeaClutterOnOffClick ), NULL, this );
	...
	RainClutterOnOff->Disconnect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( NoiseDialogBase::OnRainClutterModeClick ), NULL, this );
...
DomeDialogBase::DomeDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	DomeOffsetSelect = new wxSpinCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 80,-1 ), wxSP_ARROW_KEYS, -180, 180, 0 );
	...
	wxString DomeSpeedSelectChoices[] = { _("Normal"), _("High") };
...
NoXmitDialogBase::NoXmitDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	wxStaticBoxSizer* sbSizer18;
	sbSizer18 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, wxEmptyString ), wxVERTICAL );
	
	wxString NoXmitZoneOnOffChoices[] = { _("Off"), _("On") };
	int NoXmitZoneOnOffNChoices = sizeof( NoXmitZoneOnOffChoices ) / sizeof( wxString );
	NoXmitZoneOnOff = new wxRadioBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, NoXmitZoneOnOffNChoices, NoXmitZoneOnOffChoices, 1, wxRA_SPECIFY_ROWS );
	NoXmitZoneOnOff->SetSelection( 1 );
	sbSizer18->Add( NoXmitZoneOnOff, 0, wxALL, 5 );
	...
	StartAngle = new wxSpinCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 80,-1 ), wxSP_ARROW_KEYS, 0, 359, 0 );
	sbSizer21->Add( StartAngle, 0, wxALL, 5 );
	...
	EndAngle = new wxSpinCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 80,-1 ), wxSP_ARROW_KEYS, 0, 359, 0 );
	sbSizer22->Add( EndAngle, 0, wxALL, 5 );
	...
	wxStaticBoxSizer* sbSizer24;
	sbSizer24 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("No Xmit Zone Color") ), wxVERTICAL );
	
	m_colorpicker = new wxColourPickerCtrl( this, wxID_ANY, wxColour( 192, 192, 192 ), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL );
	sbSizer24->Add( m_colorpicker, 0, wxALL, 5 );
	
	
	sbSizer18->Add( sbSizer24, 0, wxEXPAND, 5 );
	
	wxStaticBoxSizer* nxtranpsizer;
	nxtranpsizer = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("No Xmit Zone Transparency") ), wxVERTICAL );
	
	pNXZTranSlider = new wxSlider( this, wxID_ANY, 90, 10, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS );
	nxtranpsizer->Add( pNXZTranSlider, 1, wxEXPAND, 5 );
	
	
	sbSizer18->Add( nxtranpsizer, 0, wxEXPAND, 5 );
	...
	// Connect Events
	this->Connect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( NoXmitDialogBase::OnClose ) );
	this->Connect( wxEVT_SIZE, wxSizeEventHandler( NoXmitDialogBase::OnSize ) );
	NoXmitZoneOnOff->Connect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( NoXmitDialogBase::OnNoXmitZoneClick ), NULL, this );
	StartAngle->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( NoXmitDialogBase::OnUpdateStartAngle ), NULL, this );
	EndAngle->Connect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( NoXmitDialogBase::OnUpdateEndAngle ), NULL, this );
	m_colorpicker->Connect( wxEVT_COMMAND_COLOURPICKER_CHANGED, wxColourPickerEventHandler( NoXmitDialogBase::OnColorChanged ), NULL, this );
	pNXZTranSlider->Connect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( NoXmitDialogBase::OnUpdateTranSlider ), NULL, this );
	closebutton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( NoXmitDialogBase::OnNoXmitCloseClick ), NULL, this );
}

NoXmitDialogBase::~NoXmitDialogBase()
{
	// Disconnect Events
	this->Disconnect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( NoXmitDialogBase::OnClose ) );
	this->Disconnect( wxEVT_SIZE, wxSizeEventHandler( NoXmitDialogBase::OnSize ) );
	NoXmitZoneOnOff->Disconnect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( NoXmitDialogBase::OnNoXmitZoneClick ), NULL, this );
	StartAngle->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( NoXmitDialogBase::OnUpdateStartAngle ), NULL, this );
	EndAngle->Disconnect( wxEVT_COMMAND_SPINCTRL_UPDATED, wxSpinEventHandler( NoXmitDialogBase::OnUpdateEndAngle ), NULL, this );
	m_colorpicker->Disconnect( wxEVT_COMMAND_COLOURPICKER_CHANGED, wxColourPickerEventHandler( NoXmitDialogBase::OnColorChanged ), NULL, this );
	pNXZTranSlider->Disconnect( wxEVT_SCROLL_CHANGED, wxScrollEventHandler( NoXmitDialogBase::OnUpdateTranSlider ), NULL, this );
	closebutton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( NoXmitDialogBase::OnNoXmitCloseClick ), NULL, this );
